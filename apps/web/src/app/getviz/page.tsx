    ...
    async function seedBubbleSort() {
        ...
        try {
            ...
            const existingCategory = categories.find(
                (c) =>
                    c.label.toLowerCase() === "sorting" || c.id === "sorting",
            );
            ...
            const algoCheckResult = await apiGet(
                "/api/algorithms/slug/bubble-sort",
            );
            if (algoCheckResult.ok) {
                addLog(
                    "info",
                    "Algorithm 'bubble-sort' already exists — skipping creation.",
                );
            ...
            const algoResult = await apiPost("/api/algorithms", {
                ...
                name: "Bubble Sort",
                description:
                    "A simple comparison-based sorting algorithm. It repeatedly steps through the list, compares adjacent elements and swaps them.",
                ...
                // ❗ Backend expects SINGLE code block
                displayCode: {
                    language: "javascript",
                    code: BUBBLE_SORT_JS_CODE,
                },

                // ❗ Backend expects structured forge config
                forge: {
                    forgeCode: {
                        version: 1, // ✅ REQUIRED
                        language: "js", // ✅ MUST be "js" (not "javascript")

                        body: BUBBLE_SORT_FORGE_BODY, // ✅ renamed from "code"

                        requiredStructures: ["array"], // ✅ depends on your engine (this is correct here)
                    },
            ...
            addLog(
                "success",
                "🎉 Seeding complete. Visit /viz to see the algorithm list.",
            );
        } catch (err: unknown) {
            addLog(
                "error",
        ...
        <div style={{ padding: 24, maxWidth: 800, margin: "0 auto" }}>
            ...
            >
                ...
                <p style={{ margin: "0 0 16px", color: "#555", fontSize: 14 }}>
                    Seeds a "Sorting" category and a "Bubble Sort" algorithm.
                    Idempotent — will not duplicate if run multiple times.
                </p>
                <div
                    style={{
                        display: "grid",
